<?php if (count($errors) > 0): ?>
  ...
  <?php endforeach ?>
<?php else: ?>
  <?php if ($this->config->get('veritransbin_payment_type') == 'vtweb'): ?>
    
    <div class="buttons">
      <div class="right">
        <a class="button" href="<?php echo $this->url->link('payment/veritransbin/process_order') ?>"><?php echo $button_confirm ?></a>
      </div>
    </div>
    <!-- v2 VT-Web form -->
  ...
  <?php else: ?>
    ...
    <div class="checkout-product">
      <form id="payment-form" method="post" action="<?php echo $this->url->link('payment/veritransbin/process_order') ?>">
        <table class="form">
        ...
        $(function() {
          $.getScript('https://payments.veritrans.co.id/vtdirect/veritrans.min.js')
            .done(function() {
              ...
              Veritrans.client_key = '<?php echo $this->config->get('veritransbin_client_key_v1') ?>'; // please add client-key from veritrans
      ...
      <script>
        ...
        function(){
          ...
          $.getScript(url).done(function() {
            ...
            <?php endif ?>
            Veritrans.client_key = '<?php echo $this->config->get('veritransbin_client_key_v2') ?>'; // please add client-key from veritrans
