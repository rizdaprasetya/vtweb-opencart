      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td>
              <select name="veritransbin_status">
          ...
          <tr>
            ...
            <td><input type="text" name="veritransbin_display_name" value="<?php echo $veritransbin_display_name; ?>" />
          ...
          <tr>
            <td><?php echo $entry_bin_number; ?></td>
            <td><input type="text" name="veritransbin_bin_number" value="<?php echo $veritransbin_bin_number; ?>" />
            </td>
          </tr>
          <!-- BIN Number -->
          ...
          <tr class="v2_settings sensitive">
            ...
            <td>
              <select name="veritransbin_environment">
          ...
          <tr class="v2_settings sensitive">
            ...
            <td><input type="text" name="veritransbin_client_key_v2" value="<?php echo $veritransbin_client_key_v2; ?>" />
          ...
          <tr class="v2_settings sensitive">
            ...
            <td><input type="text" name="veritransbin_server_key_v2" value="<?php echo $veritransbin_server_key_v2; ?>" />
          ...
          <tr id="veritransPaymentTypeContainer">
            ...
            <td>
              ...
              <select name="veritransbin_payment_type" id="veritransPaymentType">
                <?php foreach ($options as $key => $value): ?>
          ...
          <tr class="v2_settings sensitive">
            ...
            <td>
              <input type="checkbox" name="veritransbin_sanitization" value="on" <?php if ($veritransbin_sanitization) echo 'checked'; ?>>
            </td>
          </tr>
          <!-- Sanitization -->
          ...
          <tr class="v2_settings sensitive">
            ...
            <td>
              ...
              <?php foreach ($payment_types as $key => $val): ?>
                ...
                <input type="checkbox"
                    value="on"
                    name="veritransbin_enabled_payments[<?php echo $key; ?>]"
          ...
          <tr class="v1_settings v2_vtweb_settings sensitive">
            ...
            <td>
              <input type="checkbox" name="veritransbin_3d_secure" <?php if ($veritransbin_3d_secure) echo 'checked'; ?> />
          ...
          <tr class="v2_settings sensitive">
            ...
            <td>
              <select name="veritransbin_installment_option" id="installmentOption">
              ...
              <tr class="installment all_product_<?php echo $name_bank; ?>">
                ...
                <td>                  
                  <?php foreach (array(3, 6, 12) as $term): ?>
                    <?php $isChecked = isset(${"veritransbin_installment_".$name_bank."_term"}) && array_key_exists($term, ${"veritransbin_installment_".$name_bank."_term"})&& ${"veritransbin_installment_".$name_bank."_term"}[$term];
                    ?>
                    <input type="checkbox"
                        value="on"
                        name="veritransbin_installment_<?php echo $name_bank; ?>_term[<?php echo $term; ?>]"
                        <?php if ($isChecked) echo 'checked'; ?>>
                    <?php echo $term; ?> &nbsp;                    
                  <?php endforeach ?>
                </td>
          ...
          <?php foreach (array('vtweb_success_mapping', 'vtweb_failure_mapping', 'vtweb_challenge_mapping') as $status): ?>
            <tr class="">
              ...
              <td>
                <select name="<?php echo 'veritransbin_' . $status ?>" id="veritransPaymentType">
          ...
          <!-- VTWeb Mapping -->
            ...
            <tr>
              ...
              <td>
                <input type="text" name="veritransbin_currency_conversion" value="<?php echo $veritransbin_currency_conversion ?>" />
          ...
          <tr>
            ...
            <td>
              <select name="veritransbin_geo_zone_id">
          ...
          <tr>
            ...
            <td><input type="text" name="veritransbin_sort_order" value="<?php echo $veritransbin_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
      <div>
